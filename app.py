...
def start_background_cleanup():
    """Runs cleanup on uploads and outputs periodically in the background."""
    def loop_cleanup():
        while True:
...
def run_qc():
    try:
        ...
        macro_file = request.files.get("macro_file")  # optional
        ...
        df = rates_and_ratings_check(df, col_map["bsr"])  # sometimes repeated intentionally
